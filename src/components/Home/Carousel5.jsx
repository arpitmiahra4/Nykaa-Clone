    ...
    <div className={styles.sb_main}>
      <Carousel responsive={responsive}>
        <Box h="300px" w="250px" borderRadius={10} border="1px solid gray">
          <Image
            src="https://images-static.nykaa.com/uploads/fe745bcf-8887-4918-8dd6-1a7580f30931.jpg?tr=w-240,cm-pad_resize"
            alt="error"
            w={300}
            borderRadius="10px"
          />
        ...
        <Box h="300px" w="250px" borderRadius={10} border="1px solid gray">
          <Image
            src="https://images-static.nykaa.com/uploads/91c0e56e-535b-448d-a3ca-0b866643c448.jpg?tr=w-240,cm-pad_resize"
            alt="error"
            w={300}
            borderRadius="10px"
          />
