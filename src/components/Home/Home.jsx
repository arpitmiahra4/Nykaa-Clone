...
const Home = () => {
  ...
  return (
    ...
    <div>
      <Text fontSize={30} fontWeight="bold">Best In Beauty</Text>
      <Text fontSize={20}>Today’s Top Offers</Text>
      <Carousel1 />
    </div>
    <Box display="flex" gap={30}>
      <Image src='https://images-static.nykaa.com/uploads/e7af5dd2-c046-4223-a7f7-96b7b478bb3c.jpg?tr=w-600,cm-pad_resize' alt='upper' w={700}/>
      <Image src='https://images-static.nykaa.com/uploads/898f495b-4f78-4956-ac80-261eaf808d4f.jpg?tr=w-600,cm-pad_resize' alt='lower' w={700}/>
    </Box>
    <Box mt={50}>
    <Image src='https://images-static.nykaa.com/uploads/ede59af5-1112-4c73-bbf8-e0aa0c08444b.jpg?tr=w-1200,cm-pad_resize' w="99%" borderRadius="20px"/>
    </Box>
    <Box mt={50}>
      <Text fontWeight="bold" fontSize={30}>Top Brands</Text>
      <Text fontSize={20}>In The Spotlight</Text>
      <div className={styles.top_brands}>
      {topCard.map((el,i)=>(
        <div key={i} className={styles.top_cont}>
          <Image src={el.src} alt={`error ${i}`} width="455px" borderRadius={10}/>
    ...
    <Box mt={10} w="100%">
      <Box display="flex" gap="30px">
        <Image src='https://images-static.nykaa.com/uploads/12ea9993-f29d-4732-aa66-2de20275f641.jpg?tr=w-600,cm-pad_resize' w="48%" borderRadius={10}/>
        <Image src='https://images-static.nykaa.com/uploads/c7ae3973-167e-4ce1-b572-1364e1f5c2e2.jpg?tr=w-600,cm-pad_resize' w="48%" borderRadius={10}/>
      </Box>
        <Image m="auto" src='https://images-static.nykaa.com/uploads/14dab399-cf31-4731-992e-1845321187d6.jpg?tr=w-600,cm-pad_resize' mt="20px"  w="48%" borderRadius={10}/>
    </Box>
    
    <Box bg="#fff6f9" pb={10}>
      <Text fontWeight="bold" fontSize={30}>Only At Nykaa</Text>
      <Text fontSize={20}>Exciting Deals On Exclusive Brands</Text>
      <Box display="flex" gap="20px">
      {only_nyk.map((el,i)=>(
        <div key={i} className={styles.top_cont}>
          <Image src={el.src} alt={`error ${i}`} w="460px" borderRadius={10}/>
   ...
   <Carousel2 />
    ...
    <Box mt={30}>
      <Text fontWeight="bold" fontSize={30}>Featured Brands</Text>
      ...
      {featureBrand.map((el,i)=>(
        <div key={i} className={styles.f_inner}>
          <Image src={el.src} alt={`error ${i}`} width="300px" borderRadius={10}/>
          <div className={styles.top_content}>
          <Text fontWeight="bold">{el.title}</Text>
          <Text color="gray.700">{el.dis}</Text>
          </div>
    ...
    <Box w={"33%"} border={"1px solid grey"} borderRadius="10px">
      <Image src='https://images-static.nykaa.com/uploads/a21a0d6b-958c-4b8a-b02d-6c33844ef0bb.jpg?tr=w-400,cm-pad_resize' w={"100%"} borderRadius={10}/>
      <div className={styles.top_content}>
    ...
    <Box w={"33%"} border={"1px solid grey"} borderRadius="10px">
      <Image src='https://images-static.nykaa.com/uploads/d8e92831-dadd-41db-a5f0-873cbfeebbf6.jpg?tr=w-400,cm-pad_resize' w={"100%"} borderRadius={10}/>
      <div className={styles.top_content}>
    ...
    <Box w={"33%"} border={"1px solid grey"} borderRadius="10px">
      <Image src='https://images-static.nykaa.com/uploads/0a5105a3-c88e-4e35-ac1b-9e87752bd5bb.jpg?tr=w-400,cm-pad_resize' w={"100%"} borderRadius={10}/>
      <div className={styles.top_content}>
    ...
    <Text fontWeight="bold" fontSize={30}>Everyday Essentials</Text>
      <Text fontSize={20}>Daily Deals On Beauty Needs</Text>
      <Image src='https://images-static.nykaa.com/uploads/f6f096d9-e16d-4442-9207-b4cfe79db784.jpg?tr=w-1200,cm-pad_resize' w="1360px" mt={5} borderRadius={10} ml="20px"/>
    <Box p="10px">
    <Carousel3 />
    </Box>
    <Box mt={30}>
    <Text fontWeight="bold" fontSize={30}>Store In Focus</Text>
    <Image src='https://images-static.nykaa.com/uploads/308b1ea9-2063-4280-a219-c0e7b7f5771e.jpg?tr=w-1200,cm-pad_resize' w="1360px" mt={5} borderRadius={10} ml="20px"/>
    </Box>
    </Box>
    ...
    <Box>
    <Text fontWeight="bold" fontSize={30}>Categories In Focus</Text>
      <Text fontSize={20}>Shop Our Special Curations</Text>
      <Box mt={2} display="flex" gap={30}>
      <Image src='https://images-static.nykaa.com/uploads/5da2d82e-6ea2-4ea8-92ce-3234e2209dc6.jpg?tr=w-600,cm-pad_resize' alt='upper' borderRadius={10} w={700}/>
      <Image src='https://images-static.nykaa.com/uploads/18616ff7-b945-4dcb-9a3d-ba0bad444fc6.jpg?tr=w-600,cm-pad_resize' alt='lower' borderRadius={10} w={700}/>
    </Box>
    </Box>
    <Box mt={10}>
    <Text fontWeight="bold" fontSize={30}>Brands You Can’t Miss</Text>
    ...
    <Box mt={10}>
    <Text fontWeight="bold" fontSize={30}>Influencer's Picks</Text>
      <Text fontSize={20}>What Your Favourites Love</Text>
      <Box display="flex" gap={5}>
      {Influencer.map((el,i)=>(
        <div key={i} className={styles.influe}>
          <Image src={el.src} alt={`error ${i}`} width="340px" borderRadius={10}/>
    ...
    <Box mt={10}>
    <Text fontWeight="bold" fontSize={30}>Buying Guides</Text>
    <Text fontSize={20}>Beauty How To’s And Trends</Text>
    <Box mt={2}>
      <Carousel10 />
    </Box>
    <Box mt={5}>
    <Image src="https://images-static.nykaa.com/uploads/f4c3f4d7-a236-4e7a-92f8-e5ba0417c05e.png?tr=w-1200,cm-pad_resize" w={"98%"}/>
    </Box>
    </Box>
    <Box mt={10}>
    <Text fontWeight="bold" fontSize={30}>Game Zone</Text>
    <Text fontSize={20}>Play & Win</Text>
    <Image src='https://images-static.nykaa.com/uploads/c6048ef0-a501-451d-a4a5-e29f339e31a7.png?tr=w-1200,cm-pad_resize' w="1400px" borderRadius={10}/>
    </Box>
    <Box mt={10}>
    <Text fontWeight="bold" fontSize={30}>Gifting At Nykaa</Text>
    <Text fontSize={20}>Give The Present of Beauty</Text>
    <Box display="flex" gap={10} pt="10px">
      <Image src="https://images-static.nykaa.com/uploads/a92dac26-400d-4158-af51-a7d247658835.jpg?tr=w-600,cm-pad_resize" w="680px" borderRadius={10}/>
      <Image src="https://images-static.nykaa.com/uploads/fc68d953-2b29-42f9-8df6-5ee176ad8d01.jpg?tr=w-600,cm-pad_resize" w="680px" borderRadius={10}/>
    </Box>
    </Box>
    <Box mt={10}>
