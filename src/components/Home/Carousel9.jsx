    ...
    <div className={styles.sb_main}>
      <Carousel responsive={responsive}>
        <Box h="300px" w="250px" borderRadius={10} border="1px solid gray">
          <Image
            src="https://images-static.nykaa.com/uploads/7c880d12-bf81-4385-bb2e-c53adeebc693.jpg?tr=w-240,cm-pad_resize"
            alt="error"
            w={300}
            borderRadius="10px"
          />
        ...
        <Box h="300px" w="250px" borderRadius={10} border="1px solid gray">
          <Image
            src="https://images-static.nykaa.com/uploads/6ae9a48a-6b79-4ac1-96d8-c24ee36b26fa.jpg?tr=w-240,cm-pad_resize"
            alt="error"
            w={300}
            borderRadius="10px"
          />
        ...
        <Box h="300px" w="250px" borderRadius={10} border="1px solid gray">
          <Image
            src="https://images-static.nykaa.com/uploads/a94ce07a-a504-45e3-9e97-d3bdb19bd24b.jpg?tr=w-240,cm-pad_resize"
            alt="error"
            w={300}
            borderRadius="10px"
          />
