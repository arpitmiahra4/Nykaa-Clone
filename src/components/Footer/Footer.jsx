  ...
  return (
    <>
      <div className={style.box}>
        <div>
          <div className={style.box1}>
            <p>
              <HiOutlineMail fontSize="3.5vh" color="white" />
            </p>
        ...
        <div>
          <div className={style.box1}>
            <p>
              <GoDeviceMobile fontSize="3vh" color="white" />
            </p>
            <p>
              EXPERIENCE THE NYKAA MOBILE <br />
              APP
            </p>
          </div>
          <div className={style.box4}>
            <img
              src="https://hotelprojectleads.com/wp-content/uploads/2020/05/google-play-badge-e1522090059399.png"
              alt=""
            />
            <img
              src="https://hotelprojectleads.com/wp-content/uploads/2020/05/app-store-e1522090081753.png"
              alt=""
            />
          </div>
        </div>
        <div>
          <div className={style.box1}>
            <p>
              <BsTelephone fontSize="3vh" color="white" />
            </p>
            <p>
          ...
          <p style={{ marginLeft: "2vw", color: "white" }}>
            (Monday to Saturday, 8AM to 10PM and Sunday, 10AM to
            <br /> 7PM)
          </p>
        </div>
      </div>
      <div className={style.box5}>
        <div>
          <img
            src="https://www.cointab.in/wp-content/uploads/2022/08/Untitled-design-16-1.png"
            style={{ height: "10vh", color:"white" , marginTop:"-20px" }}
            alt=""
          />
          <p>Who are we?</p>
          <p>Careers</p>
      ...
      <div className={style.box6}>
        ...
        <div>
          ...
          <div>
            <h4 style={{ marginBottom: "0.5vh" }}>1900+ BRANDS</h4>
            <hr />
            <p style={{ marginTop: "0.5vh" }}>1.2 Lakh+ Products</p>
          </div>
        </div>
        <div>
          <div>
            <div>
              <p>
                Show us some love ❤ on social <br /> media
              </p>
            </div>
